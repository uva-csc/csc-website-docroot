...
<div id="header-icons">
  <ul>
    ...
    <!-- Giving url: https://securelb.imodules.com/s/1535/16-uva/index.aspx?sid=1535&gid=16&pgid=3711&cid=6382&appealcode=KGIVECSC&bledit=1&dids=983 -->
    <li><a alt="Support" class="noxhr top-anchor" id="support-link" href="<?php echo url('support'); ?>"><?php print_image('gift_icon.png', 24, 27, "Give Now", 'class="top-icons" id="calendar-icon"');?><div class="header-icon-text">Support</div></a></li>
    ...
    <li><a class="noxhr top-anchor" alt="Opportunities" id="opportunities-link" href="<?php echo url('opportunities');?>"><?php print_image('handshake_icon.png', 32, 32, "Opportunities", 'class="top-icons" id="opportunities-icon"');?><div class="header-icon-text">Connect</div></a></li>
