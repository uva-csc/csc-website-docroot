...
<div id="header-icons">
  <ul>
    ...
    <li><a target="_blank" alt="Support" class="noxhr top-anchor" href="<?php echo url('support'); ?>"><?php print_image('gift_icon.png', 24, 27, "Give Now", 'class="top-icons" id="calendar-icon"');?><div class="header-icon-text">Support</div></a></li>
